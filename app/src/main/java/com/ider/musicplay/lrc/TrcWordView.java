...
/**
 * Created by Eric on 2017/7/7.
 */

public class TrcWordView extends TextView {
    ...
    public TrcWordView(Context ctx)
    {
        this(ctx,null);
    }


    public TrcWordView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public TrcWordView(Context context,  AttributeSet attrs, int defStyleAttr) {
